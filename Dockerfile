...
ARG NUXT_ELASTIC_API_KEY
ARG NUXT_ELASTIC_USER
ARG NUXT_ELASTIC_PASS
...
ENV NUXT_ELASTIC_ENABLED=1
ENV NUXT_ELASTIC_HOSTNAME=https://34.142.25.45:9666
ENV NUXT_ELASTIC_API_KEY=${NUXT_ELASTIC_API_KEY}
ENV NUXT_ELASTIC_USER=${NUXT_ELASTIC_USER}
ENV NUXT_ELASTIC_PASS=${NUXT_ELASTIC_PASS}
