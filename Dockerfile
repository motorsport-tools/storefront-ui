...
ENV NUXT_STORAGE_URL=${REDIS_URL}
...
ENV NUXT_PUBLIC_CATEGORY_PAGE_FILE="~/domains/category/pages/category/[id].vue"
ENV NUXT_PUBLIC_PRODUCT_PAGE_FILE="~/domains/product/pages/product/[slug].vue"
