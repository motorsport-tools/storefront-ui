...
export type ExpressAddressInput = {
  city: InputMaybe<Scalars['String']['input']>;
...
export type Order = {
  ...
  amountDiscount: Maybe<Scalars['Float']['output']>;
...
export type UpdateCartAddress = {
  __typename?: 'UpdateCartAddress';
  cart: Maybe<CartData>;
  error: Maybe<Scalars['String']['output']>;
