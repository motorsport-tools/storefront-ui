...
<template>
  <component
    :is="wrapperTag"
    :class="[
      'flex items-center gap-2 px-4 bg-white rounded-md ring-1 text-neutral-500 hover:ring-neutral-600 active:text-[#222222] focus-within:ring-primary-700 hover:ring-primary-700',
      {
        'ring-1 ring-negative-700': invalid,
        'ring-1 ring-[#222222]': !invalid,
      },
      getSizeClasses[size],
      wrapperClass,
    ]"
