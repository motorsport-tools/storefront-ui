...
>
  <div v-if="loading" class="flex items-center justify-center h-full text-center col-span-3">
      <SfLoaderCircular size="xl" class="mt-[160px]" />
  </div>
  <div v-else-if="order" class="grid grid-cols-1 2xs:grid-cols-2 gap-4 md:gap-y-6 md:gap-x-2 md:grid-cols-2 lg:grid-cols-3 3xl:grid-cols-4 md:mb-5">
