...
const heading = isRoot ? 'account.heading' : 'account.myOrders.heading';
...
<template>
  ...
  <div class="relative z-1">
    <main class="w-full narrow-container mb-20 pt-6">
      <div>
        ...
        <div data-testid="account-layout">
          ...
          <div v-else class="flex justify-start items-center mb-10 mt-4">
            <div v-for="({ subsections }, i) in sections" :key="i">
              ...
              >
                <h1 v-if="link.startsWith(currentPath)">{{ label }}</h1>
              </div>
            </div>
            <SfButton
              :tag="NuxtLink"
